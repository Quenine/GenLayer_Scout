...
4/ v0.2 offers optional read-only RPC observations with conservative verification semantics; it does not claim Portal authority or prove contract behavior. It does not estimate points. If a field needs proof, the app asks for proof or a reason it does not apply.
